...
data class Artist(
    ...
    constructor(artistName: String, albums: List<Album>, filterSingles: Boolean, isAlbumArtist: Boolean = true) :
            this(albums.firstOrNull()?.artistId ?: -1, albums, filterSingles, true, null)

    val name: String
        get() = nameOverride ?: if (isAlbumArtist) getAlbumArtistName() ?: "-" else getArtistName()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return id == artist.id &&
                ...
                nameOverride == artist.nameOverride
    }

    override fun hashCode(): Int {
        return Objects.hash(id, songs, isAlbumArtist, filterSingles, nameOverride)
    }

    override fun toString(): String {
        return "Artist{id=$id, albums=$albums, isAlbumArtist=$isAlbumArtist, filterSingles=$filterSingles, nameOverride=$nameOverride}"
    }
